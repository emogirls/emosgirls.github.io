...
!function() {
    ...
    function d(t, n) {
        ...
        for (const r in o)
            r in e ? r in t && !(r in i) && (i[r] = e[r]) : r in n ? i[r] = n[r] : r in t && (i[r] = t[r]);
        return i
    }
    function h(t, e, n) {
        const o = t.icons
    ...
    function p(t, e) {
        const n = [];
        if ("object" != typeof t || "object" != typeof t.icons)
            return n;
    ...
    function b(t) {
        ...
        for (const t in n) {
            const e = n[t];
            if (!t.match(u) || "string" != typeof e.body || !m(e, o))
                return null
        }
    ...
    function C(t, e) {
        if ("object" != typeof t)
            return !1;
        if ("string" != typeof e && (e = t.provider || ""),
        k && !e && !t.prefix) {
            let e = !1;
            return b(t) && (t.prefix = "",
            p(t, ((t,n)=>{
    ...
    function P(t, e, n, o) {
        ...
        function v() {
            ...
            const o = s.shift();
            if (void 0 === o)
                return d.length ? void (f = setTimeout((()=>{
                    p(),
                    "pending" === u && (y(),
                    b())
                }
            ...
            d.push(i),
            l++,
            f = setTimeout(v, t.rotate),
            n(o, e, i.callback)
        }
        return "function" == typeof o && h.push(o),
        setTimeout(v),
        function() {
            return {
                startTime: c,
    ...
    const z = Object.create(null)
      ...
      , q = [];
    for (; Q.length > 0; )
        1 === Q.length || Math.random() > .5 ? q.push(Q.shift()) : q.push(Q.pop());
    function D(t, e) {
        const n = L(e);
        return null !== n && (z[t] = n,
        !0)
    ...
    function ct(t) {
        const e = t + "Storage";
        try {
            if (st && st[e] && "number" == typeof st[e].length)
                return st[e]
        } catch (t) {}
        ot[t] = !1
    }
          ...
          , r = t=>{
            ...
            if ("string" == typeof r) {
                try {
                    ...
                    if ("object" == typeof n && "number" == typeof n.cached && n.cached > i && "string" == typeof n.provider && "object" == typeof n.data && "string" == typeof n.data.prefix && e(n, t))
                        return !0
                } catch (t) {}
                tt(n, o)
            }
        ...
        if (!rt) {
            ...
            for (const t in ot)
                at(t, (t=>{
                    ...
                    return n.lastModifiedCached = n.lastModifiedCached ? Math.min(n.lastModifiedCached, o) : o,
                    !0
                }
                ))
        }
    ...
    function lt(t, e) {
        ...
        e.lastModified && !function(t, e) {
            ...
            return !0
        }(t, e.lastModified) || Object.keys(e.icons).length && (e.not_found && delete (e = Object.assign({}, e)).not_found,
        n("local") || n("session"))
    }
    function ft() {}
    function dt(t) {
            ...
            function(t) {
                ...
                setTimeout((()=>{
                    ...
                    e.forEach((e=>{
                        ...
                        r.pending.length !== s && (n || I([t], e.id),
                        e.callback(r.loaded.slice(0), r.missing.slice(0), r.pending.slice(0), e.abort))
                    }
                    ))
                }
                )))
        ...
        r.forEach((t=>{
            ...
            i[e][n].length && function(t, e) {
                ...
                setTimeout((()=>{
                    ...
                    o && (i = F(e)) && i.prepare(e, n, o).forEach((n=>{
                        B(e, n, (e=>{
                            if ("object" != typeof e)
                                n.icons.forEach((e=>{
                                    t.missing.add(e)
    ...
    function wt(t, e) {
        ...
        [o, i].forEach((t=>{
            const e = []
              ...
              , o = t.vFlip;
            let i, r = t.rotate;
            switch (n ? o ? r += 2 : (e.push("translate(" + (s.width + s.left).toString() + " " + (0 - s.top).toString() + ")"),
            e.push("scale(-1 1)"),
            s.top = s.left = 0) : o && (e.push("translate(" + (0 - s.left).toString() + " " + (s.height + s.top).toString() + ")"),
            e.push("scale(1 -1)"),
            s.top = s.left = 0),
            ...
            r % 2 == 1 && (s.left !== s.top && (i = s.left,
            s.left = s.top,
            s.top = i),
            s.width !== s.height && (i = s.width,
            s.width = s.height,
            s.height = i)),
        ...
        const a = i.width
          ...
          , f = s.height;
        let d, h;
        null === a ? (h = null === u ? "1em" : "auto" === u ? f : u,
        d = xt(h, l / f)) : (d = "auto" === a ? l : a,
        ...
        return g("width", d),
        g("height", h),
        p.viewBox = s.left.toString() + " " + s.top.toString() + " " + l.toString() + " " + f.toString(),
        {
            attributes: p,
            body: c
        }
        ...
        if ("svg" === s)
            c = function(t) {
                const e = document.createElement("span")
                  , n = t.attributes;
                let o = "";
                return n.width || (o = "width: inherit;"),
          ...
          , r = class extends n {
            ...
            attributeChangedCallback(t) {
                if ("inline" === t) {
                    const t = mt(this)
                      , e = this._state;
                    t !== e.inline && (e.inline = t,
                    Et(this._shadowRoot, t))
                } else
                    this._queueCheck()
            }
            get icon() {
            ...
            _check() {
                ...
                if (e !== t.icon.value)
                    return void this._iconChanged(e);
                if (!t.rendered)
                    return;
            ...
            _iconChanged(t) {
                const e = gt(t, ((t,e,n)=>{
                    const o = this._state;
                    if (o.rendered || this.getAttribute("icon") !== t)
                        return;
                    const i = {
                        value: t,
                        name: e,
